"""
Lesson 9: Beginner Checkpoint - a CLI assistant that decides per-question
what, if anything, to call.
...
def main() -> None:
    ...
    questions = [
        "What's the signal chain order on the guitar pedalboard?",
        "What time is it right now in New York?",
        "Which is bigger, a kilometer or a mile?",
        "How is the vinyl collection organized?",
    ]
